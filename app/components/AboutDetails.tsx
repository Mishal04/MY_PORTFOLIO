...
export default function AboutDetails() {
  return (
    <section id="about-details" className="relative w-full flex items-center justify-center py-16 md:py-24 px-6 md:px-12 lg:px-24 overflow-hidden z-10">
      ...
      <div className="w-full max-w-7xl mx-auto flex flex-col lg:flex-row gap-12 lg:gap-20 items-stretch">
        ...
        >
          <div className="relative w-full h-full min-h-[300px] sm:min-h-[350px] rounded-3xl overflow-hidden shadow-[0_0_50px_rgba(79,70,229,0.15)] border border-white/10 group">
            <Image 
            ...
            <div className="absolute bottom-8 left-0 right-0 flex justify-center gap-4 sm:gap-6 z-10">
        ...
        <div className="w-full lg:w-7/12 flex flex-col justify-center">
          <motion.div
            ...
            viewport={{ once: true, margin: "-100px" }}
          >
            <h2 className="text-indigo-400 font-semibold tracking-widest uppercase text-[10px] sm:text-xs mb-1">My Journey</h2>
            <h1 className="text-2xl md:text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-white via-indigo-200 to-indigo-500 mb-2 tracking-tight">Mishal Ashfaq</h1>
            
            <p className="text-gray-400 text-[11px] sm:text-xs md:text-sm leading-snug mb-4 font-light">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3 mb-4">
              {/* Education Panel */}
              <div className="bg-white/5 backdrop-blur-xl border border-white/10 p-3 rounded-xl shadow-xl transition-all hover:bg-white/10 group">
                <div className="flex items-center gap-2 mb-2">
                  <div className="p-1 bg-indigo-500/20 rounded-md text-indigo-400 group-hover:scale-110 transition-transform"><FaGraduationCap size={14} /></div>
                ...
                <div className="relative border-l border-white/10 pl-3 space-y-3">
                  <div className="relative">
                    ...
                    <p className="text-indigo-300 text-[9px] font-bold mb-0.5">Present (6th Semester)</p>
                    <h5 className="text-white font-medium text-[11px]">BS Computer Science</h5>
                    <p className="text-gray-400 text-[9px] mt-0.5">GC University FSD</p>
                  </div>
                  <div className="relative">
                    <div className="absolute -left-[17px] top-1 w-1.5 h-1.5 bg-white/20 rounded-full" />
                    <p className="text-indigo-300 text-[9px] font-bold mb-0.5">2018 - 2020</p>
                    <h5 className="text-white font-medium text-[11px]">Pre-Engineering</h5>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white/5 backdrop-blur-xl border border-white/10 p-3 rounded-xl shadow-xl transition-all hover:bg-white/10 group">
                <div className="flex items-center gap-2 mb-2">
                  <div className="p-1 bg-purple-500/20 rounded-md text-purple-400 group-hover:scale-110 transition-transform"><FaBriefcase size={14} /></div>
                ...
                <div className="relative border-l border-white/10 pl-3 space-y-3">
                  <div className="relative">
                    ...
                    <p className="text-purple-300 text-[9px] font-bold mb-0.5">1 Year Program</p>
                    <h5 className="text-white font-medium text-[11px]">Saylani Mass IT Training</h5>
                    <p className="text-gray-400 text-[9px] mt-0.5">Web Development Course</p>
                  </div>
                  <div className="relative">
                    <div className="absolute -left-[17px] top-1 w-1.5 h-1.5 bg-white/20 rounded-full" />
                    <p className="text-purple-300 text-[9px] font-bold mb-0.5">Ongoing</p>
                    <h5 className="text-white font-medium text-[11px]">Independent Projects</h5>
                    <p className="text-gray-400 text-[9px] mt-0.5">Building custom web apps</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            {/* Skills */}
            <div>
              <h4 className="text-[10px] font-semibold text-gray-400 uppercase tracking-widest mb-2">Tech Stack</h4>
