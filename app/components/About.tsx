...
const AbstractTechVisual = ({ paused }: { paused: boolean }) => {
  ...
  return (
    <group scale={1}>
      ...
      <mesh ref={shellRef}>
        ...
        <meshStandardMaterial color="#4f46e5" wireframe transparent opacity={0.15} emissive="#6366f1" emissiveIntensity={0.5} />
      </mesh>
      <Points ref={pointsRef} positions={particles}>
        <PointMaterial transparent color="#818cf8" size={0.05} sizeAttenuation depthWrite={false} blending={THREE.AdditiveBlending} />
      </Points>
