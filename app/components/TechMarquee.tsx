...
// Double the array so the seamless loop has content on both sides
...
export default function TechMarquee() {
  return (
    <section className="relative w-full py-10 md:py-14 overflow-hidden">
      ...
      {/* Fade masks on edges */}
      <div className="absolute inset-y-0 left-0 w-24 md:w-40 z-10 bg-gradient-to-r from-[#0a0a0a] to-transparent pointer-events-none" />
      <div className="absolute inset-y-0 right-0 w-24 md:w-40 z-10 bg-gradient-to-l from-[#0a0a0a] to-transparent pointer-events-none" />
